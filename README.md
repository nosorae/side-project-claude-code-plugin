...
여기서부터는 superpowers가 담당합니다. TDD, 서브에이전트 기반 개발, 코드 리뷰, 체계적 디버깅 — 구현 품질에 관한 건 superpowers가 더 잘합니다.
...
> 세션 관리(`/handoff`, `/resume`), 코드 리뷰, 모호한 요청 구체화 등은 superpowers와 phuryn/pm-skills가 더 잘합니다.
