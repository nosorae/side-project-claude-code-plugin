...
배포 로드맵(`docs/deploy-roadmap.md`)을 분석하여 GitHub Issues를 자동 생성하는 스킬입니다.
...
- `docs/deploy-roadmap.md` 파일이 존재해야 한다
...
1. `docs/deploy-roadmap.md`를 읽고 마일스톤/에픽/작업 구조를 파악한다
