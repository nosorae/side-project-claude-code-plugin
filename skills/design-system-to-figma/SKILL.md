...
description: "Use when the user wants to generate a mobile design system from a PRD or spec markdown file and export it to Figma. Triggered by requests like 'PRD로 디자인 시스템 만들어줘', 'Figma 디자인 시스템 생성', '/design-system-to-figma'."
---
...
- `Write` 도구로 `docs/ssot/tokens.css`에 저장
...
- `Write` 도구로 `docs/ssot/design-system.html`에 저장
...
1. **생성된 파일 목록**:
   - tokens.css 경로: `docs/ssot/tokens.css`
   - design-system.html 경로: `docs/ssot/design-system.html`
