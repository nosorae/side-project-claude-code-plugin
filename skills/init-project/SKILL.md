...
for skill in app-plan design-system-to-figma prd-to-figma dev-plan dev-roadmap create-issues; do
...
- [ ] MVP 범위 설정
- [ ] 유저 플로우 정의
- [ ] 기획서 저장 (docs/ssot/YYYY-MM-DD-{앱이름}-기획서.md)

## 검증 방법
- [ ] docs/ssot/ 에 기획서 파일 존재
...
## 검증 방법
- [ ] docs/ssot/deploy-roadmap.md 존재"
...
## 전제조건
- docs/ssot/deploy-roadmap.md 완료
...
- 스킬 6개 (app-plan, design-system-to-figma, prd-to-figma, dev-plan, dev-roadmap, create-issues)
- hooks (enforce-dialog: 대화 기록 강제)
- docs/ 디렉토리 구조 (ssot/, handoff/, lessons/)
...
- [ ] `docs/ssot/`, `docs/handoff/`, `docs/lessons/` 디렉토리가 존재하는가?
